...
import { renderJavaScriptOptions } from 'projen/lib/javascript/render-options';
 ...
 */
export class TsProjenrc extends ProjenrcFile {
  public readonly filePath: string;
  private readonly _projenCodeDir: string;
  private readonly _tsProject: TsProject;
  private readonly _swc: boolean;

  constructor(project: TsProject, options: ProjenrcOptions = {}) {
    super(project);
  ...
  private addDefaultTask() {
    ...
    this._tsProject.defaultTask?.exec(
      `${tsNode} --project ${this._tsProject.tsconfig.fileName} ${this.filePath}`,
    );
  }
  ...
  public override preSynthesize(): void {
    ...
    this._tsProject.tsconfig!.addInclude(this.filePath);
    this._tsProject.tsconfig!.addInclude(`${this._projenCodeDir}/**/*.ts`);
